# Controlling RGB LED display with Orange Pi 3B GPIO and Rockchip rk3566
...
<font color=red>Orange Pi needs to shut down the kernel `CONFIG_STRICT_DEVMEM` for `mmap` to work.</font>
